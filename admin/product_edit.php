              ...
              <form action="subcategory_update_db.php" method="post" enctype="multipart/form-data">
                ...
                <div class="form-group">
                  ...
                  <div class="form-group">
                    ...
                    <textarea  name="productdescription" class="form-control" id="productdescription" placeholder="Product Description"><?php echo $row['productdescription']; ?></textarea>
                  </div>
                  <div class="form-group">
                  ...
                  <div class="form-group">
                    ...
                    <img src="../images/products/<?php echo $row['image'] ?>"  alt="" width="200px">
                  </div>

                  <div class="form-group">
                    <label for="exampleInputFile">Select Image2</label>
                    <div class="input-group">
                      <div class="custom-file">
                  ...
                  <div class="form-group">
                    <label for="exampleInputPassword1">Old Images2</label>
                    <input type="hidden" name="oldimage2" value="<?php echo $row['image2'] ?>">
                    <img src="../images/products/<?php echo $row['image2'] ?>"  alt="" width="200px">
                  </div>
