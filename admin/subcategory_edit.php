              ...
              <form action="subcategory_update_db.php" method="post" enctype="multipart/form-data">
                ...
                <div class="form-group">
                  ...
                  <div class="form-group">
                    ...
                    <input type="text" class="form-control" id="subcatname" name="subcatname" placeholder="Category Name" value="<?php echo $row['subcatname']; ?>">
                    <input type="hidden" name="id" value="<?php echo $row['id']; ?>">
                  </div>
                  <div class="form-group">
                    <label for="exampleInputPassword1">Sub Category Description</label>
                    <textarea  name="subcatdescription" class="form-control" id="subcatdescription" placeholder="Category Description"><?php echo $row['subcatdescription']; ?></textarea>
                  </div>
                  <div class="form-group">
