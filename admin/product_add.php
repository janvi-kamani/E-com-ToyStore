      ...
      <div class="container-fluid">
        ...
        <div class="card card-primary">
              ...
              <form action="product_add_db.php" method="post" enctype="multipart/form-data">
                ...
                <div class="form-group">
                <label for="exampleInputPassword1">Products Name</label>
                <input type="text" class="form-control" id="productname" name="productname" placeholder="Products name">
                </div>
                  <div class="form-group">
                ...
                <input type="text" class="form-control" id="productprice" name="productprice" placeholder="Products price">
                </div>
