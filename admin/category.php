                    ...
                    <?php
                      ...
                      ?>
                        <tr>
                          ...
                          <td><img src="../images/categories/<?php echo $row['image'] ?>"  alt="" width="70px"></td> 
                          <td><?php echo $row['catname'];?></td>
                          <td><?php echo $row['catdescription'];?></td>
                          <td> 
                              <a href="category_delete.php?id=<?php echo $row['id'] ?>"><i class="fas fa-trash"></i>
                              <a href="category_edit.php?id=<?php echo $row['id'] ?>"><i class="fas fa-edit"></i>
                          </td>
