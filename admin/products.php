                    ...
                    <?php
                      ...
                      ?>
                        <tr>
                          ...
                          <td><img src="../images/products/<?php echo $row['image'] ?>"  alt="" width="70px"></td>   
                          ...
                          <td> 
                           <a href="product_delete.php?id=<?php echo $row['id'] ?>"><i class="fas fa-trash"></i>
                           <a href="product_edit.php?id=<?php echo $row['id'] ?>"><i class="fas fa-edit"></i>
                          </td>
